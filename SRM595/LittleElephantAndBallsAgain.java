    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            for (int i=0; i<args.length; ++i)
                LittleElephantAndBallsAgainHarness.run_test(Integer.valueOf(args[i]));
        }
    }
    // END CUT HERE
}
    ...
    static int runTestCase(int casenum__) {
        switch(casenum__) {
            case 0: {
                        ...
                        return verifyCase(casenum__, expected__, new LittleElephantAndBallsAgain().getNumber(S));
            }
            case 1: {
                        String S                  = "R";
                        int expected__            = 0;
