    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            for (int i=0; i<args.length; ++i)
                LittleElephantAndIntervalsDiv2Harness.run_test(Integer.valueOf(args[i]));
        }
    }
    // END CUT HERE
}
    ...
    static int runTestCase(int casenum__) {
        switch(casenum__) {
            case 0: {
                        ...
                        return verifyCase(casenum__, expected__, new LittleElephantAndIntervalsDiv2().getNumber(M, L, R));
            }
            case 1: {
                        int M                     = 3;
                        int[] L                   = {1, 1, 2};
